...
TENANT_COMPANY_MAP = {
    ...
    ,
    "celebrate_gannon": {
        "name": "Celebrate Gannon",
        "keywords": ["celebrate gannon", "celebrate", "gannon university", "gannon"]
    }
}
...
QUESTION_PROMPTS = {
    DiscoveryQuestion.COMPANY: {
        ...
        "cues": ["Home Depot", "Walmart", "Target", "Gannon INC", "Test Gannon", "Celebrate Gannon"]
    },
